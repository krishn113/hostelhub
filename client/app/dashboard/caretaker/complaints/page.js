...
const handleStudentClick = async (studentId) => {
  ...
  return (
    <DashboardLayout role="caretaker" activeTab="complaints">
      <div className="max-w-[1400px] mx-auto px-6 md:px-10 pt-8 pb-20 min-h-screen relative">
          ...
          {activeTab === "Complaints" ? (
            ...
            <div className="flex flex-col mb-10">
              <div className="flex flex-col gap-1">
                <h1 className="text-3xl font-black text-[#001D4C] uppercase italic tracking-tighter leading-none">
              ...
              <div className="flex justify-end mt-4">
                <div className="flex items-center gap-3 bg-white p-2 px-4 rounded-2xl border border-slate-100 shadow-sm hover:border-[#001D4C]/20 transition-all">
