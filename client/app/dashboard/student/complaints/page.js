...
export default function StudentComplaintsPage() {
  ...
  <DashboardLayout role="student" activeTab="complaints">
    {/* UPDATE: Reduced px-6 to px-4 on mobile and md:px-10 to md:px-8.
      This gives the Header more room to breathe horizontally.
    */}
    <div className="max-w-[1400px] mx-auto px-4 md:px-8 pt-6 pb-20 min-h-screen">
      <HubHeader
      ...
      {/* UPDATE: Added a wrapper with overflow-x-auto to the TabSwitcher.
        If the screen gets too narrow, the tabs will scroll instead of 
        breaking the layout or overlapping the header.
      */}
      ...
      <div className="transition-all duration-300 mt-4">
        {loading ? (
          ...
          /* UPDATE: Responsive padding for empty state 
          */
          <div className="flex flex-col items-center justify-center py-20 md:py-40 bg-white/50 rounded-3xl border-2 border-dashed border-slate-100 px-4 text-center">
